...
public class Tile : MonoBehaviour
{
    ...
    public void Init(Type _type)
    {
        ...
        switch (type)
        {
            ...
            case Type.CRATE:
                ResetVisuals();
                SetUpVisuals(visuals.crateVisuals.animController, visuals.crateVisuals.sprite[UnityEngine.Random.Range(0, 3)], visuals.crateVisuals.color);
    ...
    public void DestroyCrate()
    {
        ...
        ParticleSystem ps = GameObject.Find("Break").GetComponent<ParticleSystem>();
